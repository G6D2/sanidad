...
**Cuándo corre:** cada 15 minutos los jueves de 17 a 24 h (ART). Fuera de ese horario no corre, porque backend y frontend están en el plan free de Render (750 h/mes compartidas) y cada chequeo los despierta. Para una demo: **Actions → Chequeo de salud → Run workflow**.
