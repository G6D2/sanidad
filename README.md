...
**Cuándo corre:** cada 15 minutos, todo el día (y a mano desde **Actions → Chequeo de salud → Run workflow**). Cada chequeo despierta backend y frontend, que están en el plan free de Render (750 h/mes compartidas): si hace falta ahorrar horas, volver a una ventana acotada en el cron.
